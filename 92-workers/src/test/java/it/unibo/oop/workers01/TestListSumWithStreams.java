...
class TestListSumWithStreams {
    ...
    void testBasic() {
        ...
        final long sum = list
                ...
                .sum();
        System.out.println("BTW: the sum with " + SIZE + " elements is: " + sum); // NOPMD: allowed as this is just an exercise
        /*
        ...
        for (final int threads: new int[] { 1, 2, 3, 8, 16, 32 }) {
            ...
            System.out.println("Tried with " + threads + " thread: " // NOPMD: allowed as this is just an exercise
